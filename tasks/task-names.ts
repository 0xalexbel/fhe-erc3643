...
export const SCOPE_TOKEN_BALANCE = 'balance';
export const SCOPE_TOKEN_MINT = 'mint';
export const SCOPE_TOKEN_APPROVE = 'approve';
export const SCOPE_TOKEN_ALLOWANCE = 'allowance';
export const SCOPE_TOKEN_INC_ALLOWANCE = 'increase-allowance';
export const SCOPE_TOKEN_DEC_ALLOWANCE = 'decrease-allowance';
export const SCOPE_TOKEN_BURN = 'burn';
export const SCOPE_TOKEN_FREEZE = 'freeze';
export const SCOPE_TOKEN_UNFREEZE = 'unfreeze';
export const SCOPE_TOKEN_FROZEN_TOKENS = 'frozen-tokens';
export const SCOPE_TOKEN_PAUSE = 'pause';
export const SCOPE_TOKEN_UNPAUSE = 'unpause';
