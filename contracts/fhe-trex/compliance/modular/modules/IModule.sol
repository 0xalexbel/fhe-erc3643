...
import {euint64, ebool} from "fhevm/lib/TFHE.sol";
...
interface IModule {
     ...
     *  @param _evalue amount of tokens sent
     */
    function moduleTransferAction(address _from, address _to, euint64 _evalue) external;
     ...
     *  @param _evalue amount of tokens minted
     */
    function moduleMintAction(address _to, euint64 _evalue) external;
     ...
     *  @param _evalue amount of tokens burnt
     */
    function moduleBurnAction(address _from, euint64 _evalue) external;
     ...
     */
    function moduleCheck(address _from, address _to, euint64 _evalue, address _compliance) external returns (ebool);
