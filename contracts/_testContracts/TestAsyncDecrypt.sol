...
contract TestAsyncDecrypt is GatewayCaller {
    ...
    euint64 public xUint64x2;
    euint64 public xUint64x3;
    eaddress public xAddress;
    eaddress public xAddress2;
    ...
    uint64 public yUint64x2;
    uint64 public yUint64x3;
    ...
    constructor() {
        ...
        xUint64x2 = TFHE.asEuint64(76575465786);
        TFHE.allow(xUint64x2, address(this));
        xUint64x3 = TFHE.asEuint64(6400);
        TFHE.allow(xUint64x3, address(this));
    ...
    function callbackMixed(
        ...
        yBool = decBoolx1;
        require(decBoolx1 == decBoolx2, "Wrong decryption");
        yUint4 = decUint4;
        yUint8 = decUint8;
        yUint16 = decUint16;
        uint256[] memory params = getParamsUint256(requestID);
        ...
        yUint64 = decUint64x1;
        require(decUint64x1 == decUint64x2 && decUint64x2 == decUint64x3, "Wrong decryption");
        yAddress = decAddress;
        return yUint4;
    }
