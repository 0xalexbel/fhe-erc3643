...
import {IClaimTopicsRegistry} from "../registry/interfaces/IClaimTopicsRegistry.sol";
import {IIdentityRegistry} from "../registry/interfaces/IIdentityRegistry.sol";
import {IModularCompliance} from "../compliance/modular/IModularCompliance.sol";
import {ITrustedIssuersRegistry} from "../registry/interfaces/ITrustedIssuersRegistry.sol";
import {IIdentityRegistryStorage} from "../registry/interfaces/IIdentityRegistryStorage.sol";
...
import {IIdFactory} from "../../identity/factory/IIdFactory.sol";
import {Ownable} from "@openzeppelin/contracts/access/Ownable.sol";
import {IClaimIssuer} from "../../identity/interfaces/IClaimIssuer.sol";
...
contract TREXFactory is ITREXFactory, Ownable {
    ...
    mapping(string => address) private _tokenDeployed;
