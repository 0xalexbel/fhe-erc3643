  ...
  describe('.transferred', () => {
    describe('when not calling as a bound token', () => {
      it('should revert', async () => {
        ...
        await expect(
          compliance.connect(anotherWallet).transferred(hre.ethers.ZeroAddress, hre.ethers.ZeroAddress, 0),
    ...
    describe('when calling as a bound token', () => {
      describe('when from address is null', () => {
        it('should revert', async () => {
          ...
          await expect(
            compliance.connect(charlieWallet).transferred(hre.ethers.ZeroAddress, bobWallet.address, 10),
      ...
      describe('when to address is null', () => {
        it('should revert', async () => {
          ...
          await expect(
            compliance.connect(charlieWallet).transferred(aliceWallet.address, hre.ethers.ZeroAddress, 10),
          ).to.be.revertedWith('invalid argument - zero address');
        });
      });
  ...
  describe('.created', () => {
    describe('when not calling as a bound token', () => {
      it('should revert', async () => {
        ...
        await expect(compliance.connect(anotherWallet).created(hre.ethers.ZeroAddress, 0)).to.be.revertedWith(
    ...
    describe('when calling as a bound token', () => {
      describe('when to address is null', () => {
        it('should revert', async () => {
          ...
          await expect(compliance.connect(charlieWallet).created(hre.ethers.ZeroAddress, 10)).to.be.revertedWith(
            'invalid argument - zero address',
          );
        });
      });
      ...
      describe('when amount is zero', () => {
        it('should revert', async () => {
          ...
          await expect(compliance.connect(charlieWallet).created(bobWallet.address, 0)).to.be.revertedWith(
            'invalid argument - no value mint',
          );
        });
      });
  ...
  describe('.destroyed', () => {
    describe('when not calling as a bound token', () => {
      it('should revert', async () => {
        ...
        await expect(compliance.connect(anotherWallet).destroyed(hre.ethers.ZeroAddress, 0)).to.be.revertedWith(
          'error : this address is not a token bound to the compliance contract',
        );
      });
    });
    ...
    describe('when calling as a bound token', () => {
      describe('when from address is null', () => {
        it('should revert', async () => {
          ...
          await expect(compliance.connect(charlieWallet).destroyed(hre.ethers.ZeroAddress, 10)).to.be.revertedWith(
            'invalid argument - zero address',
          );
        });
      });
      ...
      describe('when amount is zero', () => {
        it('should revert', async () => {
          ...
          await expect(compliance.connect(charlieWallet).destroyed(aliceWallet.address, 0)).to.be.revertedWith(
