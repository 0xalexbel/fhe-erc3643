  ...
  describe('.transfer()', () => {
    ...
    describe('when the sender has not enough balance unfrozen', () => {
      it('should revert', async () => {
        ...
        await expect(token.connect(aliceWallet).transfer(bobWallet.address, balance)).to.be.revertedWith(
          'Insufficient Balance',
        );
      });
    });
    ...
    describe('when the recipient identity is not verified', () => {
      it('should revert', async () => {
        ...
        await expect(token.connect(aliceWallet).transfer(anotherWallet.address, 100)).to.be.revertedWith(
  ...
  describe('.forcedTransfer()', () => {
    describe('when sender is not an agent', () => {
      it('should revert', async () => {
        ...
        await expect(
          token.connect(aliceWallet).forcedTransfer(aliceWallet.address, bobWallet.address, 100),
    ...
    describe('when source wallet has not enough balance', () => {
      it('should revert', async () => {
        ...
        await expect(
          token.connect(tokenAgent).forcedTransfer(aliceWallet.address, bobWallet.address, balance + 1000n),
    ...
    describe('when amount is greater than unfrozen balance', () => {
      it('should unfroze tokens', async () => {
        ...
        const tx = await token
          .connect(tokenAgent)
          .forcedTransfer(aliceWallet.address, bobWallet.address, balance - 50n);
        await expect(tx)
  ...
  describe('.mint', () => {
    describe('when sender is not an agent', () => {
      it('should revert', async () => {
        ...
        await expect(token.connect(aliceWallet).mint(aliceWallet.address, 100)).to.be.revertedWith(
    ...
    describe('when recipient identity is not verified', () => {
      it('should revert', async () => {
        ...
        await expect(token.connect(tokenAgent).mint(anotherWallet.address, 100)).to.be.revertedWith(
  ...
  describe('.burn()', () => {
    describe('when sender is not an agent', () => {
      it('should revert', async () => {
        ...
        await expect(token.connect(aliceWallet).burn(aliceWallet.address, 100)).to.be.revertedWith(
          'AgentRole: caller does not have the Agent role',
        );
      });
    });
