...
async function deployMaxBalanceFullSuite() {
  ...
  const complianceModule = await ethers.getContractAt('MaxBalanceModule', proxy);
...
describe('Compliance Module: MaxBalance', () => {
  it('should deploy the MaxBalance contract and bind it to the compliance', async () => {
    const context = await deployMaxBalanceFullSuite();
      ...
      describe('when compliance preset status is false', () => {
        it('should return false', async () => {
          ...
          await context.suite.token
            ...
            .mint(context.accounts.aliceWallet.address, 1000);
          expect(await context.suite.complianceModule.canComplianceBind(context.suite.compliance)).to.be.false;
        });
      });
      ...
      describe('when compliance preset status is true', () => {
        it('should return true', async () => {
          ...
          await complianceModule
            ...
            .preSetModuleState(context.suite.compliance, context.accounts.aliceWallet.address, 100);
      ...
      describe('when compliance is not yet bound', () => {
        it('should preset', async () => {
          ...
          await expect(tx)
            ...
            .withArgs(context.suite.compliance, context.accounts.aliceWallet.address, 100);
        });
      });
    });
  });
  ...
  describe('.presetCompleted', () => {
    describe('when calling directly', () => {
      it('should revert', async () => {
        ...
        await expect(
          context.suite.complianceModule
            .connect(context.accounts.aliceWallet)
            .presetCompleted(context.suite.compliance),
        ).to.be.revertedWithCustomError(context.suite.complianceModule, `OnlyComplianceOwnerCanCall`);
      });
    });
    ...
    describe('when calling via deployer', () => {
      it('should update preset status as true', async () => {
        ...
        await complianceModule.connect(context.accounts.deployer).presetCompleted(context.suite.compliance);
    ...
    describe('when calling directly', () => {
      it('should revert', async () => {
        ...
        await expect(
          context.suite.complianceModule
            .connect(context.accounts.aliceWallet)
            .batchPreSetModuleState(context.suite.compliance, [context.accounts.aliceWallet.address], [100]),
        ).to.be.revertedWithCustomError(context.suite.complianceModule, `OnlyComplianceOwnerCanCall`);
      });
    });
      ...
      describe('when _id array is empty', () => {
        it('should revert', async () => {
          ...
          await expect(
            context.suite.complianceModule
              .connect(context.accounts.deployer)
              .batchPreSetModuleState(context.suite.compliance, [], []),
      ...
      describe('when compliance is not yet bound', () => {
        it('should preset', async () => {
          ...
          await expect(tx)
            ...
            .withArgs(context.suite.compliance, context.accounts.aliceWallet.address, 100)
            .to.emit(complianceModule, 'IDBalancePreSet')
            .withArgs(context.suite.compliance, context.accounts.bobWallet.address, 200);
        });
      });
    });
  });
    ...
    describe('when calling via compliance', () => {
      describe('when value exceeds the max balance', () => {
        it('should revert', async () => {
          ...
          await context.suite.compliance.callModuleFunction(
            new ethers.Interface(['function moduleMintAction(address _to, uint256 _value)']).encodeFunctionData(
              'moduleMintAction',
              [from, 150],
            ),
            context.suite.complianceModule,
      ...
      describe('when value does not exceed the max balance', () => {
        it('should update receiver and sender balances', async () => {
          ...
          const receiverBalance = await context.suite.complianceModule.getIDBalance(
            context.suite.compliance,
            receiverIdentity,
          );
  ...
  describe('.moduleMintAction', () => {
    describe('when calling directly', () => {
      it('should revert', async () => {
        ...
        await expect(context.suite.complianceModule.moduleMintAction(to, 10)).to.revertedWith(
          'only bound compliance can call',
        );
      });
    });
  ...
  describe('.moduleBurnAction', () => {
    ...
    describe('when calling via compliance', () => {
      it('should update sender balance', async () => {
        ...
        await context.suite.compliance.callModuleFunction(
          new ethers.Interface(['function moduleBurnAction(address _from, uint256 _value)']).encodeFunctionData(
            'moduleBurnAction',
            [from, 90],
          ),
          context.suite.complianceModule,
  ...
  describe('.moduleCheck', () => {
    describe('when identity not found', () => {
      it('should return false', async () => {
        ...
        await expect(
          context.suite.complianceModule.moduleCheck(from, to, 10, context.suite.compliance),
        ).to.revertedWith('identity not found');
      });
    });
    ...
    describe('when value exceeds compliance max balance', () => {
      it('should return false', async () => {
        ...
        const result = await context.suite.complianceModule.moduleCheck(from, to, 170, context.suite.compliance);
    ...
    describe('when user balance exceeds compliance max balance', () => {
      it('should return false', async () => {
        ...
        const result = await context.suite.complianceModule.moduleCheck(from, to, 70, context.suite.compliance);
        expect(result).to.be.false;
      });
    });
